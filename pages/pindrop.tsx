    ...
    return isLoaded ? (
        ...
        >
            {markers.map((marker) => (
                ...
                >
                    {selectedMarker && selectedMarker.details.vehicleNo === marker.vehicleNo && (
                        <InfoWindowF onCloseClick={() => setSelectedMarker(null)} position={marker.position}>
                            <div className="w-80 p-2">
                                <div className="flex items-center mb-2 space-x-5">
                                    ...
                                    />
                                    <div>
                                        <h4 className="text-xl-font-bold">vehicleNo : {selectedMarker.details.vehicleNo}</h4>
                                        <h4 className="text-xl-font-bold"> Model : {selectedMarker.details.model}</h4>
                                        <h4 className="text-xl-font-bold"> year : {selectedMarker.details.year}</h4>
                                    </div>
                                </div>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate, dolor nisi accusantium quia
                                    tenetur voluptatum. Laudantium suscipit dolores, obcaecati placeat autem voluptas libero aspernatur
                                    maiores ex aut, dignissimos quia inventore.
                                </p>
                            </div>
                        </InfoWindowF>
                    )}
